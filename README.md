...
**1. Seasonality.** While The Stanley maintains a consistent revenue floor (outperforming the average of **$91.11** for **9 months of the year**), Whitesands **experienced extreme volatility:**
...
- **Revenue instability.** Whitesands’ reliance on **a 4-month "high season"* (June to September) leaves the business vulnerable during the **8-month "low season".**
...
**For Sarova Whitesands Beach Resort and Spa:**
- **Targeted Spanish campaigns.** Whitesands should launch high-intent digital advertising in Spain during June and July to capture the maximum ADR "Transient" market.
...
The August data was analyzed further, and the results are eye-opening. While August is **the highest-earning month**, it is also **where Whitesands is losing the most potential:**
  - **Realized revenue (August):** $1,820,000
  - **Lost revenue (August):** $928,860
  - **Cancellation rate (August):** 30.74%
...
Based on the **37.74% cancellation rate** in August, **a non-refundable peak season policy** should be put in place. If Whitesands required **a 50% non-refundable deposit** for August bookings, for instance, **they could have protected a large portion of that $928k.**
